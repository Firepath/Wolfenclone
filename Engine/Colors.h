...
namespace Colors
{
	...
	static constexpr Color DarkGray = MakeRGB( 0x20u, 0x20u, 0x20u );
	static constexpr Color LightGray = MakeRGB( 0xD3u,0xD3u,0xD3u );
	static constexpr Color MediumGray = MakeRGB( 0x40u, 0x40u, 0x40u );
	static constexpr Color Red = MakeRGB( 255u,0u,0u );
	static constexpr Color Maroon = MakeRGB( 100u, 0u, 0u );
	...
	static constexpr Color LightBlue = MakeRGB( 150u, 150u, 255u );
